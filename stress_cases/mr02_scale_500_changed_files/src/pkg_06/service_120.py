"""Generated scale-test service module 120 for 500 changed-file PR robustness testing."""
...
@dataclass
class Scale500Service120Config:
    name: str
    enabled: bool = True
    retry_count: int = 3


class Scale500Service120:
    def __init__(self, config: Scale500Service120Config) -> None:
        self.config = config
        self.package_id = 6
        self.service_id = 120
    ...
    def build_cache_key(self, tenant_id: str, resource_id: str) -> str:
        ...
        return f"scale:500:pkg:6:tenant:{clean_tenant}:resource:{clean_resource}"
...
def run(payload: Dict[str, Any]) -> Dict[str, Any]:
    svc = Scale500Service120(Scale500Service120Config(name="service-120"))
    return {
